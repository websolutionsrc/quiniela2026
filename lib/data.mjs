...
// Equipos de la final (reales si se conocen; en demo, finalDemo).
export function finalTeams() {
  ...
  if (data.finalDemo) return { home: data.finalDemo.home, away: data.finalDemo.away, utcDate: '2026-07-19T18:00:00Z' };
  return null;
}
...
export function finalWindow() {
  ...
  const open = CONFIG.demo.forceOpenBracket || !passed;
